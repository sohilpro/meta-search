  ...
  <div class="flex relative items-center gap-2">
    <div class="flex w-full items-center gap-2">
      ...
      <div
        ...
        class="rounded-[16px] border relative border-[#DCDFE4] px-6 py-[10px] flex-grow cursor-pointer"
      >
        ...
        <div class="absolute z-50 h-max bg-white shadow-xl rounded-lg px-4">
          <TransitionExpand :duration="500">
...
const props = defineProps(["openModal", "execute"]);
...
const range = ref({
  start: route.query.departure_date_time,
  end: route.query.return_date_time ? route.query.return_date_time : null,
});
...
const cancelAndResetCalender = () => {
  ...
  range.value = {
    start: route.query.departure_date_time,
    end: route.query.return_date_time,
  };
};
...
const dataSelectOrigin = (i) => {
  ...
  router.push({
    ...
    query: {
      ...
      return_date_time: new Date(range.value.end).toISOString(),
