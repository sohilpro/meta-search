<template>
  <div class="flex relative items-center gap-2">
    ...
    <div
      ...
      class="rounded-[16px] border whitespace-nowrap border-[#DCDFE4] px-6 py-[10px] flex-grow cursor-pointer"
    >
    ...
    <div
      ...
      class="rounded-[16px] w-full whitespace-nowrap lg:w-auto relative border flex-grow border-[#DCDFE4] px-6 py-[10px] cursor-pointer"
    >
      <div @click="PassengerAir = !PassengerAir">
        ...
        <p class="font-bold">
          ...
          <span v-if="filtered.children"> - Child {{ filtered.children }}</span>
          <span v-if="filtered.infants"> - infants {{ filtered.infants }}</span>
        </p>
      </div>
      <div
